...
if(in_array($filecheck, $fileextstored)){
    ...
    $sql = "INSERT INTO employee(id,firstName, lastName, email, password, birthday, gender, contact,  address, dept, degree,employeeType, pic) VALUES (null,'$firstname','$lastName','$email','1234','$birthday','$gender','$contact','$address','$dept','$degree','$employeeType','$destinationfile')";
